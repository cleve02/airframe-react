        ...
        <React.Fragment>
          ...
          >
            ...
            <UncontrolledCollapse navbar toggler="#navbar-navigation-toggler">
              <Nav accent navbar>
                <NavItem>
                  <NavLink  active={location.pathname === "/layouts/sidebar-with-navbar"} tag={Link} to="/layouts/sidebar-with-navbar">
                    Preview
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink active={location.pathname === "/interface/colors"} tag={Link} to="/interface/colors">
                    Docs
                  </NavLink>
                </NavItem>
